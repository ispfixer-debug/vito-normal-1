...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>tooling</b> with <b>androidx.compose.ui:ui-tooling-preview</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseBom</b> with value <b>33.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mapsCompose</b> with value <b>4.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        private final FirebaseBundleAccessors baccForFirebaseBundleAccessors = new FirebaseBundleAccessors(objects, providers, config, attributesFactory, capabilityNotationParser);
        ...
        /**
         * Group of bundles at <b>bundles.firebase</b>
         */
        public FirebaseBundleAccessors getFirebase() {
            return baccForFirebaseBundleAccessors;
        }
    ...
    public static class ComposeBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>compose.core</b> which contains the following dependencies:
         * <ul>
        ...
        public Provider<ExternalModuleDependencyBundle> getCore() {
            return createBundle("compose.core");
        }

        /**
         * Dependency bundle provider for <b>compose.material</b> which contains the following dependencies:
         * <ul>
         ...
         * This bundle was declared in catalog libs.versions.toml
         */
        public Provider<ExternalModuleDependencyBundle> getMaterial() {
            return createBundle("compose.material");
        }
    ...
    public static class FirebaseBundleAccessors extends BundleFactory {
        ...
        public FirebaseBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Dependency bundle provider for <b>firebase.core</b> which contains the following dependencies:
         * <ul>
         ...
         *    <li>com.google.firebase:firebase-functions-ktx</li>
         * </ul>
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         */
        public Provider<ExternalModuleDependencyBundle> getCore() {
            return createBundle("firebase.core");
        }
