...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>startup</b>
     */
    public StartupLibraryAccessors getStartup() {
        return laccForStartupLibraryAccessors;
    }
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>functions</b> with <b>com.google.firebase:firebase-functions-ktx</b> coordinates and
         * with version reference <b>firebase.functions</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class StartupLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.startup</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRuntime() {
            return create("startup.runtime");
        }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.startup</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase.auth</b> with value <b>22.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase.bom</b> with value <b>32.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase.firestore</b> with value <b>24.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase.functions</b> with value <b>20.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFunctions() { return getVersion("firebase.functions"); }

        /**
         * Version alias <b>firebase.messaging</b> with value <b>23.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase.storage</b> with value <b>20.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class LifecycleRuntimeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>lifecycle.runtime</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class LifecycleViewmodelVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public LifecycleViewmodelVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>lifecycle.viewmodel</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("lifecycle.viewmodel"); }

        /**
         * Version alias <b>lifecycle.viewmodel.compose</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MlkitVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mlkit.barcode</b> with value <b>17.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>kotlinKsp</b> with plugin id <b>com.google.devtools.ksp</b> and
         * with version reference <b>ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKotlinKsp() { return createPlugin("kotlinKsp"); }
    ...
    public static class AndroidPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>android.compose</b> with plugin id <b>androidx.compose.compiler</b> and
         * with version reference <b>compose</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("android.compose"); }
